...
##### Important notice: 
The code is intended to run on Linux Virtual Machine for demonstration purpose. As such, I have not implemented memory deallocated. Please use a virtual machine (e.g. Virtual box) if you intend to try it out yourself, otherwise you may experience some memory leakage.
